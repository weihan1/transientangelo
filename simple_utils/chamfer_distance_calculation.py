...
if __name__ == "__main__":
    print(calculate_chamfer_distance("/scratch/ondemand28/weihanluo/multiview_transient_project/instant-nsr-pl/exp/transient-neuralangelo-blender-ficus/eikonal_loss=1e-9/ficus.obj", "/scratch/ondemand28/weihanluo/multiview_transient_project/instant-nsr-pl/load/transient_nerf_synthetic/ficus/ficus.obj", 2000000))